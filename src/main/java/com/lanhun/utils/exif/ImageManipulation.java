...
public class ImageManipulation {  
    ...
    public static void main(String[] args) throws Exception {  
        File infile = new File("C:\\Users\\Administrator\\Desktop\\2.jpg");
        File outfile = new File("C:\\Users\\Administrator\\Desktop\\2_1.jpg");
        ...
        jpegEncodeParam.setDensityUnit(JPEGEncodeParam.DENSITY_UNIT_DOTS_CM);
        jpegEncodeParam.setXDensity(800);
        jpegEncodeParam.setYDensity(800);
